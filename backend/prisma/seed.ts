...
async function main() {
  ...
  const additionalAgents = [
    ...
    },
    {
      ...
      slug: 'cryptotrader-pro',
      description: 'Advanced cryptocurrency trading bot that analyzes on-chain metrics, social sentiment, and technical indicators to suggest trades.',
      category: 'FINANCE',
      pricingModel: 'PER_INVOCATION',
      pricePerCall: 0.15,
      tags: ['crypto', 'trading', 'web3'],
      invocations: 3412, earnings: 511.80, rating: 4.5, stakers: 45, staked: 25000.0,
    },
    {
      name: 'SupportBot X',
      slug: 'supportbot-x',
      description: '24/7 autonomous customer support agent capable of resolving billing issues, processing refunds, and answering product FAQs.',
      category: 'CUSTOMER_SUPPORT',
      pricingModel: 'PER_TOKEN',
      pricePerToken: 0.00005,
      tags: ['support', 'customer-service', 'ecommerce'],
      invocations: 8901, earnings: 445.05, rating: 4.8, stakers: 67, staked: 42000.0,
    },
    {
      name: 'HR Assistant AI',
      slug: 'hr-assistant-ai',
      description: 'Automates candidate screening, schedules interviews, and answers employee questions regarding company policies and benefits.',
      category: 'AUTOMATION',
      pricingModel: 'PER_INVOCATION',
      pricePerCall: 0.08,
      tags: ['hr', 'recruiting', 'management'],
      invocations: 1205, earnings: 96.40, rating: 4.6, stakers: 22, staked: 13500.0,
    },
    {
      name: 'Polyglot Translator',
      slug: 'polyglot-translator',
      description: 'Real-time translation agent supporting over 50 languages. Preserves cultural nuances, idioms, and formatting.',
      category: 'CHATBOT',
      pricingModel: 'FREE',
      pricePerCall: 0.0,
      tags: ['translation', 'language', 'localization'],
      invocations: 5623, earnings: 0.0, rating: 4.9, stakers: 51, staked: 28000.0,
    },
    {
      name: 'UI/UX Reviewer',
      slug: 'ui-ux-reviewer',
      description: 'Analyzes frontend code and provides accessibility, performance, and UI consistency recommendations based on material design.',
      category: 'CODE_ASSISTANT',
      pricingModel: 'PER_INVOCATION',
      pricePerCall: 0.05,
      tags: ['design', 'frontend', 'accessibility'],
      invocations: 834, earnings: 41.70, rating: 4.7, stakers: 16, staked: 8200.0,
    },
    {
      name: 'SalesColdCaller',
      slug: 'sales-cold-caller',
      description: 'Generates personalized cold email templates and LinkedIn outreach messages based on a prospects background and company.',
      category: 'AUTOMATION',
      pricingModel: 'PER_INVOCATION',
      pricePerCall: 0.06,
      tags: ['sales', 'outreach', 'marketing'],
      invocations: 2156, earnings: 129.36, rating: 4.4, stakers: 34, staked: 16500.0,
    }
  ];
